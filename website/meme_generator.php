...
?>
	...
	<h1 style='clear:both; padding-top:50px'>Your Uploads</h1>
...
?>
	...
	<script type="text/javascript">
		//Uploads scrolling (duplicate code from user.php with slight changes)
		...
		//Group and keyword auto complete and tags
		var group_tags = [];
		var keyword_tags = [];
		var options, a;
